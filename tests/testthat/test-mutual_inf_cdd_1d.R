test_that("mutual_inf_cdd_1d returns expected result", {
  ...
  result <- cond_mutual_inf_cdd_1d(mutual_info_df$Zc_XdYd, mutual_info_df$Xd,
                                   mutual_info_df$Yd)
...
test_that("mutual_inf_cdd_1d issues error messages when vector sizes are different", {
  ...
  expect_error( cond_mutual_inf_cdd_1d(mutual_info_df$Zc_XdYd[-1],
                                       mutual_info_df$Xd,
                                       mutual_info_df$Yd))
  expect_error( cond_mutual_inf_cdd_1d(mutual_info_df$Zc_XdYd,
                                       mutual_info_df$Xd[-1],
                                       mutual_info_df$Yd))
  expect_error( cond_mutual_inf_cdd_1d(mutual_info_df$Zc_XdYd,
                                       mutual_info_df$Xd,
